          ...
          <div class="col-lg-8">
            <div class="p-3">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4"><b>Edit Slider</h1>
                </div>

                <?php
                include "koneksi.php";
                $sql = $conn->query("SELECT * FROM slider WHERE judul='$_GET[judul]'");
                $row = $sql->fetch_assoc();
                ?>
                ...
                <form method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <img width="70px" src="img/slider/<?php echo $row['gambar'];?>" id="showgambar">
                    <p></p>
                ...
                if(isset($_POST['simpan'])){
                  ...
                  if ($gambar == "") {
                    #hanya update text
                    $sql = $conn->query("UPDATE slider SET 
                      judul='$judul' WHERE judul='$_GET[judul]'");
                    if ($sql) {
                      # cek data berhasil
                      ?>
                      <script type="text/javascript">
                        alert("Data Berhasil di Update"); document.location = '?halaman=dataslider';
                      </script>
                      <?php
                    } else {
                      # cek data gagal
                      ?>
                      <script type="text/javascript">
                        alert("Data Gagal di Update"); document.location = '?halaman=dataslider';
                      </script>
                      <?php
                    }
                  } else {
                    # code...
                    $tempat_foto = "img/slider/$gambar";
